...
<script>
	...
	export default {
		...
		methods: {
            ...
            that.sheng=that.shopdata.usTsProvince
            that.shi=that.shopdata.usTsCity
            that.qu=that.shopdata.usTsArea
					}
				});
			},
			...
			gosubmit: function() {
				...
				var dataJson = {
					...
					usToIsOpen:that.shopdata.usTraderOperate.usToIsOpen,//是否营业
